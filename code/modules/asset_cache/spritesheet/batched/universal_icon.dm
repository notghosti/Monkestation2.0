...
/datum/universal_icon/proc/copy() as /datum/universal_icon
...
/datum/universal_icon/proc/blend_color(color, blend_mode) as /datum/universal_icon
	if(!transform)
		transform = new
	transform.blend_color(color, blend_mode)
	return src

/datum/universal_icon/proc/blend_icon(datum/universal_icon/icon_object, blend_mode) as /datum/universal_icon
	if(!transform)
		transform = new
	transform.blend_icon(icon_object, blend_mode)
	return src

/datum/universal_icon/proc/scale(width, height) as /datum/universal_icon
	if(!transform)
		transform = new
	transform.scale(width, height)
	return src

/datum/universal_icon/proc/crop(x1, y1, x2, y2) as /datum/universal_icon
	if(!transform)
		transform = new
...
/datum/universal_icon/proc/shift(dir, amount, icon_width, icon_height) as /datum/universal_icon
	if(!transform)
		transform = new
...
/datum/universal_icon/proc/change_opacity(amount) as /datum/universal_icon
	if(!transform)
		transform = new
...
/datum/universal_icon/proc/to_list() as /list
	RETURN_TYPE(/list)
...
/proc/universal_icon_from_list(list/input_in) as /datum/universal_icon
	RETURN_TYPE(/datum/universal_icon)
...
/datum/universal_icon/proc/to_icon() as /icon
...
/datum/icon_transformer/proc/apply(icon/target) as /icon
...
/datum/icon_transformer/proc/copy() as /datum/icon_transformer
...
/datum/icon_transformer/proc/to_list() as /list
	RETURN_TYPE(/list)
...
/proc/icon_transformer_from_list(list/input) as /datum/icon_transformer
...
/proc/color_transform(color=null) as /datum/icon_transformer
...
/proc/gags_to_universal_icon(atom/path) as /datum/universal_icon
...
/proc/get_flat_uni_icon(image/appearance, deficon, defstate, defblend, start = TRUE, parentcolor) as /datum/universal_icon
